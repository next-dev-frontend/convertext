...
const Advantages = () => {
  ...
  return (
    ...
    <section id="code" className="select-none container mx-auto pt-4 pb-10 w-full max-w-5xl">
      ...
      <div className="flex flex-wrap text-gray-500">
        <div className="w-full px-4 text-sm md:text-md lg:text-lg">
          <div className="mx-auto align-middle">
            ...
            <p className="mt-1 text-sm md:text-md lg:text-lg text-gray-500">
      ...
      <div className="flex flex-wrap text-gray-500">
        <div className="w-full px-4 text-sm md:text-md lg:text-lg">
          <div className="mx-auto align-middle">
            ...
            <pre className="hljs block overflow-x-auto p-2 bg-gray-900 text-white">
              {code}
            </pre>
