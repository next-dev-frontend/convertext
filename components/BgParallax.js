  ...
  return (
    <div>
      <section id="bgParallax" className="select-none relative mx-auto flex bg-center bg-fixed bg-no-repeat items-center bg-cover justify-center w-full max-w-full h-96 px-4 py-8">
        <img loading="lazy" className="absolute w-full h-full top-0 left-0 bg-cover bg-center bg-no-repeat bg-fixed" src="/backgrounds/bg3-convertext.webp" alt="Image Background" />
