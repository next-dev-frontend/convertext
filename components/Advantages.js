          ...
          <div className="mx-auto align-middle text-justify">
            ...
            <div className="space-y-4">
              <details className="group border rounded border-gray-300 bg-gray-50 px-2 py-2">
                <summary className="flex bg-colorRed rounded cursor-pointer items-center justify-between gap-1.5 p-4">
                  <p className="text-lg font-medium text-white">
                    IMPORTANT
                  </p>
                  <span className="shrink-0 rounded-full bg-white p-1.5 text-colorRed sm:p-3">
